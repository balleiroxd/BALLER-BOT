...
┃│🔎 ⋟ ${prefix}igstory (Nome Do Usuário) 
...
┃│✰ ⋟ ${prefix}ModoZerorpg (1/0) - Ativar recurso no grupo.
┃│✰ ⋟ ${prefix}RgZerocity (Nome) - Funciona somente com o modo ativo.
┃│✰ ⋟ ${prefix}SairZerocity (Apagar seus registros) - Funciona somente com o modo ativo.
┃│✰ ⋟ ${prefix}Rpglistgp (Lista de registrados na Zero's City no grupo)
┃│✰ ⋟ ${prefix}MeuZerocity (Suas informações)
┃│✰ ⋟ ${prefix}Minhacarteira (Informações Bancárias)
┃│✰ ⋟ ${prefix}RankZerocity (Os 10 mais ricos da Zero's City)
...
┃│✰ ⋟ ${prefix}Meupix (Sua chave pix na ZeroCity)
...
┃│✰ ⋟ ${prefix}Pescaria
┃│✰ ⋟ ${prefix}Itenspesca (Comprar os itens nescessários para pesca)
┃│✰ ⋟ ${prefix}Trocarbanco 
┃╰══ ⪨
╰═══════════════════ ⪨`
}
